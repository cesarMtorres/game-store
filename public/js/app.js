...
window.Vue = vue__WEBPACK_IMPORTED_MODULE_0__["default"];
 ...
 // importaciones y config de vue-router
...
var Home = function Home() {
  return Promise.resolve().then(function webpackMissingModule() { var e = new Error("Cannot find module './components/Home.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; });
};

var Contact = function Contact() {
  return Promise.resolve().then(function webpackMissingModule() { var e = new Error("Cannot find module './components/Contact.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; });
}; // components blog


var Show = function Show() {
  return Promise.resolve().then(function webpackMissingModule() { var e = new Error("Cannot find module './components/game/Show.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; });
};

var Create = function Create() {
  return Promise.resolve().then(function webpackMissingModule() { var e = new Error("Cannot find module './components/game/Create.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; });
};

var Edit = function Edit() {
  return Promise.resolve().then(function webpackMissingModule() { var e = new Error("Cannot find module './components/game/Edit.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; });
};
